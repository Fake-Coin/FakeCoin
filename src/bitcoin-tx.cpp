...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s fakecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  fakecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fakecoin transaction") + "\n" +
              "  fakecoin-tx [options] -create [commands]   " + _("Create hex-encoded fakecoin transaction") + "\n" +
              "\n";
