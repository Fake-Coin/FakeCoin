...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // FakeCoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // FakeCoin: 2.5 minutes
...
unsigned char pchMessageStart[4] = { 0x3C, 0xD1, 0xAF, 0x3E };
