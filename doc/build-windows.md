...
Below are some notes on how to build FakeCoin-qt for Windows.

The options known to work for building FakeCoin-qt on Windows are:

* On Linux using the [Mingw-w64](https://mingw-w64.org/doku.php) cross compiler tool chain. Ubuntu Trusty 14.04 is recommended
and is the platform used to build the FakeCoin-qt Windows release binaries.
...
for Ubuntu Xenial does not produce working executables for some of the FakeCoin-qt applications.
...
Acquire the source in the usual way:
    ...
    git clone -b fakecoin-0.10.4 https://github.com/Fake-Coin/FakeCoin-qt
...
Once the source code is ready the build steps are below.
    ...
    CONFIG_SITE=$PWD/depends/x86_64-w64-mingw32/share/config.site ./configure --prefix=$PWD/depends/x86_64-w64-mingw32 --with-qrencode
    make
